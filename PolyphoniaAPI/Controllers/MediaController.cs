...
namespace PolyphoniaAPI.Controllers
{
    ...
    public class MediaController : ControllerBase
    {
        ...
        public MediaController(PolyphoniaDatabaseContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Media>> PostMedia(Media media)
        {
          if (_context.Media == null)
          {
              return Problem("Entity set 'PolyphoniaDatabaseContext.Media'  is null.");
          }
        ...
        {
            return (_context.Media?.Any(e => e.IdMedia == id)).GetValueOrDefault();
        }
    }
}
